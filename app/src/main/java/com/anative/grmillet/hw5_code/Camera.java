...
public class Camera {
    ...
    private final float INIT_POS_X = 5.0f;
    private final float INIT_POS_Y = 10.0f;
    private final float INIT_POS_Z = 20.0f;

    // //////////////////////////////////////////////////////////////////////
    public Camera() { // initial Value
        pos[0] = INIT_POS_X;        pos[1] = INIT_POS_Y;        pos[2] = INIT_POS_Z;
        uAxis[0] = 1.0f;        uAxis[1] = 0.0f;        uAxis[2] = 0.0f;
        vAxis[0] = 0.0f;        vAxis[1] = 1.0f;        vAxis[2] = 0.0f;
        nAxis[0] = 0.0f;        nAxis[1] = 0.0f;        nAxis[2] = 1.0f;
        fovy = 60.0f;
    }
